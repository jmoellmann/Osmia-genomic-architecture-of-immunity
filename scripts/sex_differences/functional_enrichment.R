...
for(ontology in c("BP", "MF", "CC")){
  ...
  for(tool in c("STAR", "kallisto")){
    res <- DESeq2::results(readRDS(paste0(
      "results/PRJNA285788/sex_differences/diff_expr/", tool, "/dds_lrt.RDS")))
    ...
    write_tsv(gsea_ns100, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                 tool, "/funct_enrich/", ontology, "/gsea_dm_ns100.tsv"))
    write_tsv(gsea_ns150, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                 tool, "/funct_enrich/", ontology, "/gsea_dm_ns150.tsv"))
    
    write_tsv(gsea_bt_ns10, paste0("results/PRJNA285788/sex_differences/diff_expr/",
                                tool, "/funct_enrich/", ontology, "/gsea_bt_ns10.tsv"))
    write_tsv(gsea_bt_ns20, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                tool, "/funct_enrich/", ontology, "/gsea_bt_ns20.tsv"))
    
    write_tsv(gsea_imm_gene_ns10, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                             tool, "/funct_enrich/", ontology, "/gsea_imm_gene_ns10.tsv"))
    write_tsv(gsea_imm_gene_ns20, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                             tool, "/funct_enrich/", ontology, "/gsea_imm_gene_ns20.tsv"))
    write_tsv(gsea_imm_gene_ns50, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                             tool, "/funct_enrich/", ontology, "/gsea_imm_gene_ns50.tsv"))
    write_tsv(gsea_imm_gene_ns100, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                             tool, "/funct_enrich/", ontology, "/gsea_imm_gene_ns100.tsv"))
    write_tsv(gsea_imm_gene_ns150, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                             tool, "/funct_enrich/", ontology, "/gsea_imm_gene_ns150.tsv"))
    
    write_tsv(gsea_imm_gene_bt_ns10, paste0("results/PRJNA285788/sex_differences/diff_expr/", 
                                             tool, "/funct_enrich/", ontology, "/gsea_imm_gene_bt_ns10.tsv"))
