...
for(ontology in c("CC", "MF", "BP")){
  ...
  dir.create(paste0("results/PRJNA285788/sex_differences/funct_enrich/", ontology), 
             showWarnings = FALSE, recursive = TRUE)
  
  res_all <- read_csv("results/PRJNA285788/sex_differences/diff_splicing/res_all.csv")
  ...
  write_tsv(gsea_ns20, paste0("results/PRJNA285788/sex_differences/diff_splicing/funct_enrich/", 
